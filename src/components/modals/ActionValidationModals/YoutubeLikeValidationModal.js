...
import { campaignParticipateYoutubeLikeValidation } from '../../../actions/campaign'
      ...
      <ModalBody>
        ...
        <div className="mt-3 d-flex justify-content-center">
          <Button
            ...
            onClick={onSubmit}
            loading={CAMPAIGN_PARTICIPATE_YOUTUBE_LIKE_VALIDATION_PROCESS}
          >
            {!CAMPAIGN_PARTICIPATE_YOUTUBE_LIKE_VALIDATION_PROCESS && t('button_group.confirm')}
          </Button>
        </div>
...
export default YoutubeLikeValidationModal
