...
function FacebookMessageField(props) {
      ...
      >
        ...
        <div>
          ...
          <span
            ...
            onClick={() => setAction('facebook', 'comment', false)}
          >
        ...
        <Row className="mt-3">
          <Col xs="12" sm="6" className="p-0 pr-sm-2">
            <Input
              ...
              value={params.facebook.comment_model}
              onChange={(e) => setAction('facebook', 'comment_model', e.target.value)}
            />
          </Col>
          <Col size="12" className="p-0 justify-content-end align-items-center mt-3 mt-sm-0">
            <Row>
              <Col xs="12" sm="6" className="p-0 pl-sm-2">
                <Input
                  value={params.facebook.comment_entries}
                  onChange={(e) => setAction('facebook', 'comment_entries', e.target.value)}
              ...
              <Col xs="12" sm="6" className="p-0 d-flex align-items-center justify-content-end mt-3 mt-sm-0">
                <Checkbox checked={params.facebook.comment_mandatory} onChange={(e) => setAction('facebook', 'comment_mandatory', e.target.checked)} />
...
export default FacebookMessageField