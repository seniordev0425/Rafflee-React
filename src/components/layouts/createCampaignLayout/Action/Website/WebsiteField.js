      ...
      >
        ...
        <div>
          ...
          <span
            ...
            onClick={() => setParams('url_website', params.url_website.filter(item => item.id !== action.id))}
          >
        ...
        <Row>
          <Col xs="12" sm="6" className="p-0">
            <Input
              ...
              value={action.url}
              onChange={(e) => setAction('url_website', action.id, { ...action, url: e.target.value })}
            />
          </Col>
            ...
            <Row>
              <Col xs="12" sm="6" className="p-0">
                <Input
                  ...
                  onChange={(e) => setAction('url_website', action.id, { ...action, entries: e.target.value })}
              ...
              <Col xs="12" sm="6" className="p-0 d-flex align-items-center justify-content-end mt-3 mt-sm-0">
                <Checkbox checked={action.mandatory} onChange={(e) => setAction('url_website', action.id, { ...action, mandatory: e.target.checked })} />
