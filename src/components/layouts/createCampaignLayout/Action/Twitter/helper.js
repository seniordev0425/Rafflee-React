...
export const twitterActionsMap = (action) => {
  if (action.twitter_comment_tweet) {
    return {
      ...
      comment_like: action.twitter_comment_tweet_like || '',
      comment_retweet: action.twitter_comment_tweet_retweet || '',
    ...
    return {
      ...
      like_like: action.twitter_like_like || '',
      like_retweet: action.twitter_like_retweet || '',
    ...
    return {
      ...
      retweet_like: action.twitter_retweet_like || '',
      retweet_retweet: action.twitter_retweet_retweet || '',
