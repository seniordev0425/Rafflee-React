  ...
  useEffect(() => {
    if (selectedCampaign) {
      ...
      setParams({
        ...
        twitter: {
          comment: selectedCampaign.action_participate[0].social_action[3].twitter_tweet,
          comment_model: selectedCampaign.action_participate[0].social_action[3]?.twitter_tweet_model || '',
          comment_entries: selectedCampaign.action_participate[0].social_action[3]?.twitter_tweet_entries || '',
          comment_mandatory: selectedCampaign.action_participate[0].social_action[3]?.twitter_tweet_mandatory || false,
        ...
        poll: selectedCampaign.action_participate[0].poll ?
          {
            ...
            mutiples_choices: selectedCampaign.action_participate[0].poll.multiple_choices,
