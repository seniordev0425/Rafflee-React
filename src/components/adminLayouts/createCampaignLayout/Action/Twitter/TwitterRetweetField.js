      ...
      >
        <Row>
          <Col xs="12" sm="6" className="p-0">
            <TwitterRetweetSelector action={action} setAction={setAction} />
          </Col>
          <Col size="12" className="p-0 justify-content-end align-items-center mt-3 mt-sm-0">
            <Row>
              <Col xs="12" sm="6" className="p-0">
                <Input
                  value={action.retweet_entries}
                  onChange={(e) => setAction('twitter', action.id, { ...action, retweet_entries: e.target.value })}
              ...
              <Col xs="12" sm="6" className="p-0 d-flex align-items-center justify-content-end mt-3 mt-sm-0">
                <Checkbox checked={action.retweet_mandatory} onChange={(e) => setAction('twitter', action.id, { ...action, retweet_mandatory: e.target.checked })} />
        ...
        {action.retweet_id &&
          <div className="mt-4 d-flex">
            <img
              src={action.retweet_profile_img}
              width={50}
              height={50}
            ...
            <div className="ml-4 color-gray font-size-12">
              ...
              <div className="mt-4">
                ...
                <span className="ml-3">
                  {moment(action.retweet_created_at).format('YYYY-MM-DD')}
                </span>
              </div>
            </div>
          </div>
